...
colors:
  ...
  dark-background: "#1c1815"
  dark-surface: "#241f1b"
  dark-surface-soft: "#2a2420"
  dark-surface-elevated: "#302a25"
  dark-on-surface: "#efebe6"
  dark-on-surface-muted: "#a89f94"
  dark-outline: "rgba(255, 245, 235, 0.08)"
  dark-outline-strong: "rgba(255, 245, 235, 0.15)"
  dark-primary: "#ff7700"
  dark-primary-strong: "#ff851a"
  dark-primary-warm: "#ffc266"
  dark-primary-focus: "#fa822c"
  dark-shell-bg: "rgba(15, 10, 8, 0.75)"
  dark-shell-border: "rgba(255, 245, 235, 0.12)"
  dark-status-mock-bg: "rgba(251, 191, 36, 0.15)"
  dark-status-mock-fg: "#fbbf24"
  dark-status-planned-bg: "rgba(168, 162, 158, 0.15)"
  dark-status-planned-fg: "#a8a29e"
  dark-status-development-bg: "rgba(96, 165, 250, 0.15)"
  dark-status-development-fg: "#60a5fa"
  dark-status-integrated-bg: "rgba(192, 132, 252, 0.15)"
  dark-status-integrated-fg: "#c084fc"
  dark-status-production-bg: "rgba(74, 222, 128, 0.15)"
  dark-status-production-fg: "#4ade80"
typography:
  display-hero:
